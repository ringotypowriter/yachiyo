...
import {
  ...
  type YachiyoServer
} from '../yachiyo-server/app/host/YachiyoServer.ts'
import {
...
} from '../yachiyo-server/channels/platforms/telegram/telegramService.ts'
import {
  createQQService,
  type QQService
} from '../yachiyo-server/channels/platforms/qq/qqService.ts'
import {
  createQQBotService,
  type QQBotService
} from '../yachiyo-server/channels/platforms/qqbot/qqbotService.ts'
import {
  createDiscordService,
  type DiscordService
} from '../yachiyo-server/channels/platforms/discord/discordService.ts'
import {
  ...
  discordPolicy,
  qqbotPolicy
} from '../yachiyo-server/channels/shared/channelPolicy.ts'
import {
