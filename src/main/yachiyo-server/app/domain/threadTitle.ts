  ...
  return [
    {
      role: 'user',
      content: [
        'Generate a short conversation title and a single emoji icon from the message below.',
        'Reply with exactly two lines and nothing else:',
        '- Line 1: exactly one emoji that represents the thread topic',
        '- Line 2: the title text (2–6 words, plain text only, no emoji)',
        '',
        'Rules:',
        '- The title MUST be in the same language as the message. If the message is in Japanese, title in Japanese. If Chinese, title in Chinese. Never translate.',
        '- Do not add labels like "Emoji:" or "Title:".',
        `- Keep the title under ${MAX_THREAD_TITLE_LENGTH} characters.`,
        '- Do not repeat the message verbatim.',
        '- Compress the message into a compact topic label.',
        '- Avoid filler like "Chat" or "Conversation".',
        '',
        'Examples:',
        'Message: Plan the MVP for a note-taking app',
        '📝',
        'Note-Taking MVP Plan',
        '',
        'Message: Fix the flaky login redirect after refresh',
        '🐛',
        'Login Redirect Flake',
        '',
        "Message: Write an email asking to reschedule tomorrow's interview",
        '📧',
        'Interview Reschedule Email',
        '',
        'Message: 明日の面接をリスケするメールを書いて',
        '📧',
        '面接リスケメール作成',
        '',
        'Message: 帮我优化这个SQL查询的性能',
        '⚡',
        'SQL查询性能优化',
        '',
        'Message:',
