...
import type { ActivitySnapshotDisplay, ActivitySnapshotRect } from '@yachiyo/shared/protocol'
import type { SampleResult, SampleWindowBounds } from '@yachiyo/runtime/activity/osascript'
