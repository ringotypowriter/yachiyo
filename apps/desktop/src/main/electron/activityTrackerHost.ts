...
import type { ActivityTrackingConfig } from '@yachiyo/shared/protocol'
import { getActivityTracker } from '@yachiyo/runtime/activity/ActivityTracker'
import { recognizeActivityScreenshot } from '@yachiyo/runtime/activity/visionOcr'
...
function resolveVisionOcrHelperPath(): string | undefined {
  ...
  const candidates = [
    ...
    join(app.getAppPath(), '../../native/vision-ocr/.build/release/vision-ocr')
  ]
