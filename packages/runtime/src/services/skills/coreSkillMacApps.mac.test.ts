...
test('macos-apps scripts are executable and accept --help', async () => {
  const scripts = [
    'packages/core-skills/core-skills/yachiyo-macos-apps/scripts/mail_compose.py',
    'packages/core-skills/core-skills/yachiyo-macos-apps/scripts/mail_list.py',
    'packages/core-skills/core-skills/yachiyo-macos-apps/scripts/notes_create.py',
    'packages/core-skills/core-skills/yachiyo-macos-apps/scripts/notes_search.py',
    'packages/core-skills/core-skills/yachiyo-macos-apps/scripts/reminders_list_lists.py',
    'packages/core-skills/core-skills/yachiyo-macos-apps/scripts/reminders_create.py',
    'packages/core-skills/core-skills/yachiyo-macos-apps/scripts/reminders_list.py',
    'packages/core-skills/core-skills/yachiyo-macos-apps/scripts/calendar_list_calendars.py',
    'packages/core-skills/core-skills/yachiyo-macos-apps/scripts/calendar_create_event.py',
    'packages/core-skills/core-skills/yachiyo-macos-apps/scripts/calendar_list_events.py'
  ]
...
test('macos-apps mail_compose.py produces JSON draft without sending', { skip: isCI }, async () => {
  const report = (await runCommandJson(
    resolve(rootDir, 'packages/core-skills/core-skills/yachiyo-macos-apps/scripts/mail_compose.py'),
...
test('macos-apps notes_search.py produces valid JSON', { skip: isCI }, async () => {
  const report = (await runCommandJson(
    resolve(rootDir, 'packages/core-skills/core-skills/yachiyo-macos-apps/scripts/notes_search.py'),
    ['--query', 'test', '--json']
