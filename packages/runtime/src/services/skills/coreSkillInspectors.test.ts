...
test('docx inspector reports placeholders and structure', async () => {
  ...
  try {
    ...
    const report = (await runJsonScript(
      resolve(rootDir, 'packages/core-skills/core-skills/yachiyo-docx/scripts/docx_inspect.py'),
      path
    )) as {
...
test('xlsx inspector reports sheets formulas and workbook features', async () => {
  ...
  try {
    ...
    const report = (await runJsonScript(
      resolve(rootDir, 'packages/core-skills/core-skills/yachiyo-xlsx/scripts/xlsx_inspect.py'),
      path
    )) as {
      sheet_count: number
      table_count: number
...
test('pptx inspector reports slide text and notes presence', async () => {
  ...
  try {
    ...
    const report = (await runJsonScript(
      resolve(rootDir, 'packages/core-skills/core-skills/yachiyo-pptx/scripts/pptx_inspect.py'),
      path
    )) as {
      slide_count: number
...
test('pdf inspector reports basic PDF facts', async () => {
  ...
  try {
    ...
    const report = (await runJsonScript(
      resolve(rootDir, 'packages/core-skills/core-skills/yachiyo-pdf/scripts/pdf_inspect.py'),
      path
    )) as {
      exists: boolean
...
test('pdf field lister finds simple AcroForm names', async () => {
  ...
  try {
    ...
    const report = (await runJsonScript(
      resolve(
        rootDir,
        'packages/core-skills/core-skills/yachiyo-pdf/scripts/pdf_list_form_fields.py'
      ),
      path
    )) as {
...
test('docx fill template replaces placeholder text in copied output', async () => {
  ...
  try {
    ...
    const report = (await runCommandJson(
      resolve(
        rootDir,
        'packages/core-skills/core-skills/yachiyo-docx/scripts/docx_fill_template.py'
      ),
...
test('xlsx export sheet csv writes selected sheet content', async () => {
  ...
  try {
    ...
    const report = (await runCommandJson(
      resolve(
        rootDir,
        'packages/core-skills/core-skills/yachiyo-xlsx/scripts/xlsx_export_sheet_csv.py'
      ),
...
test('pptx replace text updates target slide content', async () => {
  ...
  try {
    ...
    const report = (await runCommandJson(
      resolve(
        rootDir,
        'packages/core-skills/core-skills/yachiyo-pptx/scripts/pptx_replace_text.py'
      ),
