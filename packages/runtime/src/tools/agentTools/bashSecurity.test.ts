...
EOF`,
    ...
    describe('isSelfLaunchCommand', () => {
      ...
      const blocked = [
        ...
        '/usr/bin/open -a "Yachiyo"',
        'open -a "/Applications/Yachiyo.app"',
        '"/Applications/Yachiyo.app/Contents/MacOS/Yachiyo"',
        'MODE=test /usr/bin/env -u DEBUG sudo -u root exec /usr/bin/open "/Applications/Yachiyo.app"',
        'command -- nohup open /Applications/Yachiyo.app',
        '(open /Applications/Yachiyo.app)',
        'echo ok && (open /Applications/Yachiyo.app)',
        '{ open /Applications/Yachiyo.app; }',
        '> /tmp/yachiyo-launch.log open /Applications/Yachiyo.app',
        '2>/tmp/yachiyo-launch.log open /Applications/Yachiyo.app',
        'open 2>/tmp/yachiyo-launch.log /Applications/Yachiyo.app',
        'exec -a test /Applications/Yachiyo.app/Contents/MacOS/Yachiyo',
        'sudo exec -a test /Applications/Yachiyo.app/Contents/MacOS/Yachiyo',
        'open -a /tmp/Yachiyo.app/env',
        'shasum -a 256 /tmp/Yachiyo.app/Yachiyo && open /Applications/Yachiyo.app',
        'xcrun simctl install 83DB936A-04EA-4BA6-BBC4-100395AA6BE1 /tmp/Debug-iphonesimulator/Yachiyo.app; open /Applications/Yachiyo.app',
        'cat /tmp/Yachiyo.app/Info.plist | open /Applications/Yachiyo.app',
        'echo ok || open /Applications/Yachiyo.app',
        'echo ok & open /Applications/Yachiyo.app',
        'echo ok\nopen /Applications/Yachiyo.app',
        "# don't restart\nopen /Applications/Yachiyo.app",
        'bash -lc \'echo ok; open "/Applications/Yachiyo.app"\'',
        "env MODE=test /bin/sh -c '/Applications/Yachiyo.app/Contents/MacOS/Yachiyo'",
        '/usr/bin/osascript -e "tell application \\"Yachiyo\\" to activate"',
      ...
      const allowed = [
        ...
        'cat README.md',
        'xcrun simctl install 83DB936A-04EA-4BA6-BBC4-100395AA6BE1 /tmp/Debug-iphonesimulator/Yachiyo.app',
        'xcrun simctl install 83DB936A-04EA-4BA6-BBC4-100395AA6BE1 "/tmp/Build Products/Debug-iphonesimulator/Yachiyo.app"',
        'shasum -a 256 /tmp/Debug-iphonesimulator/Yachiyo.app/Yachiyo',
        'shasum -a 256 /Applications/Yachiyo.app/Contents/MacOS/Yachiyo',
        'env MODE=test shasum -a 256 "/Applications/Yachiyo.app/Contents/MacOS/Yachiyo"',
        'ls -ld /Applications/Yachiyo.app',
        'cat /Applications/Yachiyo.app/Contents/Info.plist',
        'echo "open /Applications/Yachiyo.app; osascript application \\"Yachiyo\\""',
        'echo osascript; echo \'application "Yachiyo"\'',
        'shasum -a 256 /tmp/Yachiyo.app/Yachiyo && echo done | cat',
        "bash -lc 'shasum -a 256 /tmp/Yachiyo.app/Yachiyo'",
        'open /Applications/Other.app',
        'echo "(open /Applications/Yachiyo.app)"',
        '# don\'t run open "/Applications/Yachiyo.app"\necho ok',
        'echo ok # open "/Applications/Yachiyo.app"',
        'echo "# open /Applications/Yachiyo.app"',
        '(shasum -a 256 /tmp/Yachiyo.app/Yachiyo)',
        'cat < /Applications/Yachiyo.app/Contents/Info.plist',
        '> /tmp/check.log shasum -a 256 /tmp/Yachiyo.app/Yachiyo',
        'command -v /Applications/Yachiyo.app/Contents/MacOS/Yachiyo',
