...
import type { CreateScheduleInput, UpdateScheduleInput } from '@yachiyo/shared/protocol'
import { ScheduleDomain } from '@yachiyo/runtime/app/domain/schedules/scheduleDomain'
...
export async function handleScheduleCommand(
  ...
  const { createSqliteYachiyoStorage } = await import('@yachiyo/runtime/storage/sqlite/database')
